    ...
    <div className="min-h-screen bg-white dark:bg-[#000000] flex flex-col">
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        <div className="flex items-start gap-4 mb-8">
          ...
          <h1 className="text-gray-900 dark:text-white">Disclaimer</h1>
        </div>
        ...
        <div className="bg-white dark:bg-[#000000] border border-gray-200 dark:border-[#333333] p-6 rounded-2xl space-y-4 text-gray-700 dark:text-[#D1D5DB]">
          <p>
            Screndly does not guarantee publication success, increased engagement, monetization, or platform compliance outcomes. All automations interact with third-party sites at the user's risk. If a third-party platform restricts automation or revokes API access, Screndly bears no responsibility for resulting delays, errors, or account actions.
          </p>
          
          <p>
            Generated media may require licensing depending on how and where the user publishes it. Nothing created by Screndly constitutes legal, financial, copyright, or business advice. Users should validate that their automations comply with the terms of each external platform.
          </p>
        </div>
      </div>
